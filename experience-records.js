...
.amr-title { font-family: 'Noto Serif KR', serif; font-size: 18px; color: #4A4A4A; margin-bottom: 6px; }
.amr-desc { font-size: 14.5px; color: #6E6763; line-height: 1.9; }
.amr-msg { font-size: 14.5px; color: #6E6763; line-height: 1.9; padding: 18px 0; }
...
.amr-chip { font-size: 14px; color: #4A4A4A; border: 0.5px solid #e8e4e0; background: #FAFAF8; padding: 4px 11px; }
.amr-action { font-size: 15px; line-height: 1.9; color: #4A4A4A; }
.amr-exp { margin-top: 8px; }
.amr-exp span { display: block; font-size: 15px; line-height: 1.8; color: #4A4A4A; }
.amr-exp small { display: block; margin-top: 2px; font-size: 13px; color: #6E6763; }
...
.amr-orig { margin: 0; font-size: 13px; color: #6E6763; }
.amr-egroup label { display: block; margin-top: 10px; font-size: 13px; color: #6E6763; }
...
.amr-status { margin-bottom: 12px; padding: 10px 14px; border: 0.5px solid #e8e4e0;
              background: #fff; font-size: 14px; text-align: center; color: #4A4A4A; }
...
.amr-sum-title { font-family: 'Noto Serif KR', serif; font-size: 16px; color: #4A4A4A; margin-bottom: 4px; }
.amr-sum-desc { font-size: 14px; color: #6E6763; line-height: 1.8; margin-bottom: 14px; }
.amr-steps { list-style: none; margin: 0; padding: 0; display: grid; gap: 10px; }
.amr-steps li { font-size: 14.5px; line-height: 1.8; color: #4A4A4A; }
.amr-steps small { display: block; font-size: 13px; color: #6E6763; }
.amr-empty { font-size: 14px; color: #6E6763; }
`;
